...
{
	if(AEnemyAICharacter* EnemyCharacter = Cast<AEnemyAICharacter>(OtherActor)) {
		EnemyCharacter->OnEnemyTakeDamage(20.0f);
		Destroy();
		return;
	}
